...
///  use it. It incluceds a UnityEvent completionEvent that is invoked when the
...
public class BezierMover : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Get u from the currrent time and duration
        // uranges from 0 to 1 (usually)
        ...
        {
            if (u < 1) // 0 < 1, which means this is active and moving
            {
                state = eState.active;
            }
