...
public class Card : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="eSuit"></param>
    /// <param name="eRank"></param>
    /// <param name="startFaceUp"></param>
    ...
    // An Euler rotation of 180 degrees around the Z-axis will flip sprites upside down
    ...
    private void AddDecorators()
    {
        ...
        foreach (JsonPip pip in JsonParseDeck.DECORATORS)
        {
            ...
            // Name this GO so it's easy to find in the Hierarchy
            _tGO.name = pip.type;
            // Add this decorator GO to the List card.decoGOs
            decoGOs.Add(_tGO);
        }
    }
    ...
    private void AddPips()
    {
        ...
        {
            // Instantiate a GO from the Deck.SPRITE_PREFAB static field
    ...
    private void AddBack()
    {
        ...
        _tGO.transform.localPosition = Vector3.zero;
        // 2 is a higher sotringOrder than anything else
