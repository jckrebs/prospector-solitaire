...
public class FloatingScore : MonoBehaviour
{
    ...
    {
        get { return (_score); }
        set { _score = value; textField.text = _score.ToString("#,##0"); }
    }

    // Define a function delegate type with on FloatingScore parameter.
    ...
    /// <summary>
    /// This is largetly a passthrough for BezierMover
    /// </summary>
